...
import DarkPoolInterface from "@/components/navs/darkpool/darkpool/DarkPoolInterface";
...
export default function DarkPoolPage() {
  ...
  // Get wallet from walletManager or localStorage (same as main dapp page)
  useEffect(() => {
    const updateWallet = () => {
    ...
    const handleWalletConnected = () => updateWallet();
    const handleWalletDisconnected = () => setConnectedWallet(null);
