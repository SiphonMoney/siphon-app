...
export default function DetailsModal({
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      addLog('Sending strategy to FHE executor backend...');
      showToast('Sending to FHE executor... Check the Run tab for pending strategy.', 'loading');
      ...
      if (result.success) {
        ...
        const poll = async (): Promise<void> => {
          ...
          if (reached) {
            ...
            showToast('Strategy submitted! Check the Run tab for your pending strategy.', 'success');
