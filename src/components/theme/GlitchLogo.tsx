...
export default function GlitchLogo({ className = "", svgClassName = "" }: GlitchLogoProps) {
  return (
    <div className={`${styles.glitchLogoWrap} ${className}`.trim()}>
      <GlitchShell>
        <svg
          className={`${styles.svg} ${svgClassName}`.trim()}
